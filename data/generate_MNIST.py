...
from data_utils import separate_data, save_file, split_data
...
def generate_dataset(dir_path, num_clients, niid, balance, partition):
    ...
    X, y, statistic = separate_data((dataset_image, dataset_label), batch_size, train_ratio, alpha, num_clients, num_classes, 
